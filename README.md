...
```
This socket provides access to the [QEMU monitor](https://www.qemu.org/docs/master/system/monitor.html) (HMP - Human Monitor Protocol) and can be used to control the virtual machine.
